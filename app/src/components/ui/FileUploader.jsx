      ...
      >
        {uploading ? (
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="w-full max-w-xs bg-slate-100 dark:bg-slate-700 rounded-full h-1.5">
              <div
          ...
          <div className={`flex flex-col items-center gap-${compact ? '1' : '2'} text-center`}>
            <UploadCloud className="text-slate-300 dark:text-slate-600" size={compact ? 22 : 32} />
            <p className={`${compact ? 'text-xs' : 'text-sm'} text-slate-500 dark:text-slate-400 font-medium`}>
              Arraste arquivos ou{' '}
      ...
      {existingFiles.length > 0 && (
        <div className="space-y-2">
          {existingFiles.map((file) => (
            <div
              key={file.id}
              className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700 group"
            >
